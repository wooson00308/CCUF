...
다른 프레임워크는 47개 에이전트와 72개 스킬을 제공합니다.
이 프레임워크는 7개 스킬과 2개 훅만 제공합니다. 전부 실전에서 검증된 것들입니다.

| 다른 프레임워크 | CCUF |
|----------------|------|
| "CRAP 원칙을 따르세요" | 실제로 동작하는 RGB 값을 제공합니다 |
| "LayoutGroup을 올바르게 사용하세요" | 실제 버그에서 나온 11개 규칙이 있습니다 |
| "씬 파일을 직접 편집하지 마세요" | 훅이 편집 시도를 자동으로 차단합니다 |
